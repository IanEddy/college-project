	...
	<div class="container  clearfix">
		<div class="one-third1 column">
			<ul>
				...
				<li class="active"><a href="parties.php"><img alt="" src="img/parties.png"><span>faculties</span></a></li>
		...
		<div class="two-thirds1 column">
			...
			<a rel="facebox" href="addparty.php"><img alt="" src="img/add-item.png"></a>
			<table id="resultTable" data-responsive="table">
				...
				<tbody>
					...
					<tr class="record">
						...
						<td><a rel="facebox" href="editparties.php?id=<?php echo $row['id']; ?>"> <img alt="" src="img/edit.png"> </a> </a> | <a href="#" id="<?php echo $row['id']; ?>" class="delbutton" title="Click To Delete"><img alt="" src="img/delete-item.png"></a></td>
					</tr>
					<?php
						}
					?>
