	...
	<div class="container  clearfix">
		<div class="one-third1 column">
			<ul>
				...
				<li class="active"><a href="course.php"><img alt="" src="img/page.png"><span>Schools</span></a></li>
		...
		<div class="two-thirds1 column">
			...
			<div id="formdesign"><input type="text" name="filter" value="" id="filter" placeholder="search..." autocomplete="off" /></div>
                        <a rel="facebox" href="addcourse.php"> <img alt="" src="img/add-item.png" > </a>
			<table id="resultTable" data-responsive="table">
				...
				<tbody>
					...
					<tr class="record">
						...
						<td><a rel="facebox" href="editcourse.php?id=<?php echo $row['id']; ?>"> <img alt="" src="img/edit.png" >  </a> | <a href="#" id="<?php echo $row['id']; ?>" class="delbutton" title="Click To Delete"><img alt="" src="img/delete-item.png" > </a></td>
					</tr>
					<?php
						}
					?>
