	...
	<div class="container  clearfix">
		<div class="one-third1 column">
			<ul>
				...
				<li class="active"><a href="candidates.php"><img alt="" src="img/candidates.png"><span>Candidates</span></a></li>
		...
		<div class="two-thirds1 column">
			...
			<a rel="facebox" href="addcandidates.php"><img alt="" src="img/add-item.png"></a>
			<table id="resultTable" data-responsive="table">
				...
				<tbody>
					...
					?>
					<tr class="record">
						<td><a rel="facebox" href="editphoto.php?id=<?php echo $row['id']; ?>"><img src="candidates/<?php echo $row['image']; ?>" /></a></td>
						...
						<td><a rel="facebox" href="editcandidates.php?id=<?php echo $row['id']; ?>"> <img alt="" src="img/edit.png"> </a> | <a href="#" id="<?php echo $row['id']; ?>" class="delbutton" title="Click To Delete"><img alt="" src="img/delete-item.png"></a></td>
					</tr>
					<?php
						}
					?>
